...
export const issuableCredentialTypes: {
  ...
  'ProofOfEventOrganizerCredential': {
    ...
    context: [{
      ProofOfEventOrganizerCredential: 'http://terms.condidi.com/ProofOfEventOrganizerCredential',
  ...
  'EventInvitationCredential': {
    ...
    context: [{
      EventInvitationCredential: 'http://terms.condidi.com/EventInvitationCredential',
      schema: 'http://schema.org/',
  ...
  'ProofOfEventAttendanceCredential': {
    ...
    context: [{
      EventInvitationCredential: 'http://terms.condid.com/EventInvitationCredential',
      schema: 'http://schema.org/',
      presenter: 'schema:performer',
      name: 'schema:name',
      about: 'schema:about',
